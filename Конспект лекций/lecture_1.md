...
* $-\nabla{p}-$  равнодействующая сил давления. Знак минуса указывает на то, что эта сила действует против направления движения жидкости. Видно, что если движение обусловлено давлением, то $p\downarrow$ при движении вниз по потоку. <br>
...
**Пространственная форма двумерного ячеистого течения в режимах стационарного ламинарного течения соответствует распределениям изолиний функции тока, которые при этом совпадают с траекториями движения жидкости.**
